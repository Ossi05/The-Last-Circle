...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
            ...
            m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex) 
                ...
                .OnComplete(
                    operation =>
                    {
                        ...
                        if (CheckForDublicateBindings(action, bindingIndex, allCompositeParts))
                        {
                            action.RemoveBindingOverride(bindingIndex);
                            CleanUp();
        ...
        bool CheckForDublicateBindings(InputAction action, int bindingIndex, bool allCompositePards = false)
        {
            InputBinding newBinding = action.bindings[bindingIndex];
            ...
            foreach (InputBinding binding in action.actionMap.bindings)
            {
                ...
                {
                    Debug.Log("Dublicate binding found: " + binding.effectivePath);
                    return true;
                }
            }

            if (allCompositePards)
            {
        ...
        [SerializeField]
        public InteractiveRebindEvent m_RebindStopEvent;
